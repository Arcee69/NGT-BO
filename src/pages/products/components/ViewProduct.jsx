...
const ViewProduct = ({ handleClose, productData }) => {
  ...
  return (
    <div className='w-[600px] h-[500px] overflow-y-scroll mt-[20px] px-5 rounded-lg bg-[#fff] flex flex-col pt-5 '>
        ...
        <div className='flex flex-col gap-5'>
            <img src={productData?.image_1} alt='thumbnail' className='w-[300px] h-[300px] mx-auto' />
            <div className='flex flex-col gap-3'>
                ...
                <p className='text-[#000] text-lg font-mont font-semibold'>Product Category: <span className='text-sm font-poppins font-medium'>{productData?.category?.name} Pieces</span></p>
