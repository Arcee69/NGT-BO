...
const EditCategory = ({ handleClose, editCategoryLoading, getAllCategory, setEditCategoryLoading, editData }) => {
    ...
    const submitForm = (values, action) => {
        ...
        api.post(appUrls?.GET_PRODUCTS_CATEGORY_URL + `/update`, data)
        .then((res) => {
                ...
                <Form onSubmit={handleSubmit} className="flex ">
                    <div className="flex flex-col gap-[27px]">
                        ...
                        <div className='mt-[26px] flex items-center gap-3'>
                            ...
                            >
                                <p className='text-[#fff] text-sm font-semibold'>{editCategoryLoading ? <CgSpinner className=" animate-spin text-xl " /> : 'Save Category'}</p>
