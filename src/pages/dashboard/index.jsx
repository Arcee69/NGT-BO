    ...
    <div className='p-8'>
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center gap-4'>
            <div className='w-[40px] h-[40px] invisible bg-[#fff] flex items-center justify-center rounded-lg p-2'>
            ...
            <select
              className='w-[130px] h-[40px] bg-[#fff] flex items-center outline-none cursor-pointer justify-between rounded-lg p-2'
              value={timeRange}
