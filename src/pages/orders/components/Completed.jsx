...
const Completed = ({ allCompletedOrders, loading }) => {
  ...
  return (
    <div className='mt-6'>
      <div className='flex items-center justify-between'>
        ...
        <div className='w-[200px] h-[40px] bg-[#fff] p-2 hidden flex items-center justify-between rounded'>
                    ...
                    <tr key={index} className='bg-white h-[56px] border-t cursor-pointer border-grey-100' onClick={() => navigate("/orders/completed", {state: data})}>
                        ...
                        <td className='h-[70px] px-4'>
                            <div className={`rounded-lg h-8 flex justify-center items-center w-[99px] bg-[#ECFDF5] `}>
                                <p className={`text-sm font-Mont text-left font-semibold text-[#10B981]`}>Completed</p>
                            </div>
                        </td>
                    </tr>
                )) : (
